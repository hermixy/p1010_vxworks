/* cds8548.h - Freescale MPC8548 CDS board header */
...
--------------------
01e,11jul07,d_l  Add FIT divider defines.(WIND00063974)
01d,30aug06,dtr  Modify PCI Express params.
01c,26jan06,dtr  Fix comments for registers and tidy up.
01b,11jan06,dtr  Modify interrupt for Arcadia X3 board.
01a,04jun05,dtr  Created from cds85xx/cds85xx.h/01w 
*/

/*
This file contains I/O addresses and related constants for the
FreeScale MPC8548 CDS board. 
*/
...
#define CCB_FREQ           ((OSCILLATOR_FREQ)*(PLAT_RATIO_400_MHZ)) 
...
#ifdef ARCADIA_X31
#define PCI_SLOT1_DEVNO        0x8             /* PCI IRQ0 SLOT Device no */
#else
