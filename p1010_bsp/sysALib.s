...
#include <arch/ppc/mmuE500Lib.h>
	...
	FUNC_EXPORT(mtspr_mas0)
	FUNC_EXPORT(mfspr_mas0)
	FUNC_EXPORT(mfspr_mas1)
	FUNC_EXPORT(mfspr_mas2)
	FUNC_EXPORT(mfspr_mas3)
	FUNC_EXPORT(mfspr_tlb1cfg)
	FUNC_EXPORT(get_curpc)
	FUNC_EXPORT(write_tlb)
...
FUNC_LABEL(_sysInit)		
FUNC_BEGIN(sysInit)
/*	lis r5,HIADJ(0xffe41020)
	addi r5,r5,LO(0xffe41020)
	lis r6,HIADJ(0xa0000000)
	addi r6,r6,LO(0xa0000000)
	stwx r6,0,r5
	eieio*/
	mr  r8, r3
        xor p0,p0,p0
...
FUNC_BEGIN(mtspr_mas0)
	mtspr MAS0, r3
	isync
	blr
FUNC_END(mtspr_mas0)

FUNC_BEGIN(mfspr_mas0)
	mfspr r3, MAS0
	isync
	blr
FUNC_END(mfspr_mas0)

FUNC_BEGIN(mfspr_mas1)
	mfspr r3, MAS1
	isync
	blr
FUNC_END(mfspr_mas1)

FUNC_BEGIN(mfspr_mas2)
	mfspr r3, MAS2
	isync
	blr
FUNC_END(mfspr_mas2)

FUNC_BEGIN(mfspr_mas3)
	mfspr r3, MAS3
	isync
	blr
FUNC_END(mfspr_mas3)

FUNC_BEGIN(mfspr_tlb1cfg)
	mfspr r3, 0x2b1
	isync
	blr
FUNC_END(mfspr_tlb1cfg)

FUNC_BEGIN(get_curpc)
	mflr r3
	isync
	blr
FUNC_END(get_curpc)

FUNC_BEGIN(write_tlb)
	mtspr	MAS0,r3
	mtspr	MAS1,r4
	mtspr	MAS2,r5
	mtspr	MAS3,r6
